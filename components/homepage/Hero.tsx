...
export default function Hero() {
  return (
    <section className="relative min-h-[720px] w-full overflow-hidden bg-[#071D49] sm:min-h-[760px] lg:h-[650px] lg:min-h-0">
      <div
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#020B1F]/95 via-[#071D49]/75 to-[#071D49]/20" />
      ...
      <div className="relative z-10 mx-auto flex min-h-[720px] max-w-[1500px] items-center px-6 py-12 sm:min-h-[760px] lg:h-full lg:min-h-0 lg:px-10 lg:py-0">
        <div className="max-w-[650px] text-white">
          ...
          <h1 className="mb-6 text-[42px] font-bold leading-[1.05] sm:text-5xl lg:mb-7 lg:text-7xl">
            Fast, Reliable Deliveries When Your Business Needs Them Most
          </h1>

          <p className="mb-8 max-w-[580px] text-[20px] leading-8 text-white/90 sm:text-xl lg:mb-9">
            Streamline Logistics Group provides dependable collection and
            delivery services for businesses across the UK. From urgent
            same-day consignments to multi-drop and full-load deliveries,
            we ensure your goods reach their destination safely and on time.
          </p>
