      ...
      <div className="mx-auto max-w-7xl p-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 mt-2">Assigned, active and completed jobs.</p>
          </div>
          <button onClick={loadJobs} className="rounded-full bg-[#07182f] px-5 py-3 text-white flex gap-2 items-center">
        ...
        <div className="mt-6 relative">
          ...
          <input
            ...
            className="w-full rounded-2xl border bg-white pl-12 pr-4 py-4"
          />
        </div>
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <div className="mt-3 flex gap-6 text-sm text-slate-600">
                      <span className="flex items-center gap-2"><Calendar size={16}/>{job.collectionWindow}</span>
                      <span className="flex items-center gap-2"><Truck size={16}/>{job.status}</span>
                    </div>
                    <p className="mt-4"><strong>Collection:</strong> {job.collectionAddress}</p>
                    <p className="mt-2"><strong>Delivery:</strong> {job.deliveryAddress}</p>
                  </div>
