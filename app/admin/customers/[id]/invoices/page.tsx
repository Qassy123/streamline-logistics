    ...
    try {
      ...
      setInvoices(
        Array.isArray(data.invoices)
          ? data.invoices
          : Array.isArray(data.relatedInvoices)
  ...
  return (
    <div className="space-y-6">
      <Header
        ...
        description={`Invoice history for ${customerName(customer)}.`}
      ...
      {!loading ? (
        <div className="grid gap-4 sm:grid-cols-2">
          <SummaryCard label="Invoice records" value={String(invoices.length)} />
          <SummaryCard label="Outstanding" value={formatMoney(outstanding)} />
        </div>
      ) : null}
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="This customer has no linked invoices."
        />
      ) : (
